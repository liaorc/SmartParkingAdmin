 ...
 */
public class ConfirmedListFragment extends ListFragment {
...
//            confirmButton.setFocusable(false);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_confirmed_list,container, false);
        mListView = (ListView)v.findViewById(android.R.id.list);

        View header = inflater.inflate(R.layout.header_view_confirmed_list, mListView, false);
        ...
        public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
            ...
            try {
                ...
                if (serverRequest.getStatusCode() == 0) {
                    ConfirmedOrders.get(getActivity()).update(serverRequest.getData(), 0);
                }
            } catch (Exception e){
