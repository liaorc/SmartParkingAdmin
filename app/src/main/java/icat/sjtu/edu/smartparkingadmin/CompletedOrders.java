...
public class CompletedOrders {
    ...
    private static CompletedOrders sConfirmedOrders;
    ...
    private CompletedOrders(Context appContext) {
        mAppContext = appContext;
        mOrders = new ArrayList<Order>();
        mNextPage = 0;
    }

    public static CompletedOrders get(Context c) {
        if (sConfirmedOrders == null) {
            sConfirmedOrders = new CompletedOrders(c.getApplicationContext());
        }
